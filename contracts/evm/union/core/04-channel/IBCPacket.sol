...
contract IBCPacket is IBCStore, IIBCPacket, ModuleManager {
    ...
    function sendPacket(
        ...
        IbcCoreClientV1Height.Data memory latestHeight = client.getLatestHeight(
            clientId
        );
    ...
    function acknowledgePacket(
        ...
        if (
            ...
            uint64 expectedAckSequence = uint64(
                uint256(
                    commitments[
                        IBCCommitment.nextSequenceAckCommitmentKey(
                            msg_.packet.source_port,
                            msg_.packet.source_channel
                        )
                    ]
    ...
    function timeoutPacket(
        ...
        uint64 proofTimestamp = client.getTimestampAtHeight(
